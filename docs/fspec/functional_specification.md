...
* implementation of matching algorithm in the frontend?

*Brenton Chasse and Grayson Kempster, 03/13/15, Tyler Caldwell 5/7/15*
...
* <b>User object contains</b>:
	* Display Name - username
	* Password
	* Real name
	* University
	* Courses
		* List of courses the user selects
	* Preferences
		* Quiet study or talkative collaboration
	* Online
		* Field indicating whether signed in or out
	* Matches
		* List of users who go to the same school and have common courses
